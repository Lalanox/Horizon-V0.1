function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords, id)
	...
	self.variables = {}
	self.weight = weight
	self.maxWeight = extendedConfig.MaxWeight
	self.id = id
	if extendedConfig.Multichar then self.license = 'license'..string.sub(identifier, 6) else self.license = 'license:'..identifier end
